...
(lazy-define2 (utils library cursor) notify-cursor-moved)
(lazy-define2 (utils edit variants) make-inline-tag-list)
(lazy-define2 (utils edit variants) make-wrapped-tag-list)
(lazy-define2 (utils cas cas-out) cas->stree)
(lazy-define2 (utils plugins plugin-cmd) pre-serialize)
(lazy-define2 (utils plugins plugin-cmd) verbatim-serialize)
(lazy-define2 (utils test test-convert) delayed-quit)
(lazy-define2 (utils test test-convert) build-manual)
(lazy-define2 (utils test test-convert) build-ref-suite)
(lazy-define2 (utils test test-convert) run-test-suite)
