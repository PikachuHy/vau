...
DECLARE_GLUE_NAME_TYPE_BASE(texmacs_time,"texmacs-time", int (*) (), time_t (*) ())
...
DECLARE_GLUE_NAME_TYPE_BASE(obtain_ip,"tree-ip", path (*) (tree), path (*) (tree&))
DECLARE_GLUE_NAME_TYPE(tree_active,"tree-active?", bool (*) (tree))
DECLARE_GLUE_NAME_BASE(strong_equal,"tree-eq?", bool (*) (tree, tree))
DECLARE_GLUE_NAME_TYPE_BASE(subtree,"subtree", tree (*) (tree, path), tree& (*) (tree&,path))
...
DECLARE_GLUE_NAME_TYPE_BASE(correct_node,"cpp-tree-correct-node", void (*) (tree), void (*) (tree&))
DECLARE_GLUE_NAME_TYPE_BASE(correct_downwards,"cpp-tree-correct-downwards", void (*) (tree), void (*) (tree&))
DECLARE_GLUE_NAME_TYPE_BASE(correct_upwards,"cpp-tree-correct-upwards", void (*) (tree), void (*) (tree&))
...
DECLARE_GLUE_NAME_TYPE_BASE(next_tag,"path-next-tag", path (*) (content, path, scheme_tree_t), path (*) (tree, path, tree))
DECLARE_GLUE_NAME_TYPE_BASE(previous_tag,"path-previous-tag", path (*) (content, path, scheme_tree_t), path (*) (tree, path, tree))
DECLARE_GLUE_NAME_TYPE_BASE(next_tag_same_argument,"path-next-tag-same-argument", path (*) (content, path, scheme_tree_t), path (*) (content, path, scheme_tree))
DECLARE_GLUE_NAME_TYPE_BASE(previous_tag_same_argument,"path-previous-tag-same-argument", path (*) (content, path, scheme_tree_t), path (*) (content, path, scheme_tree))
...
DECLARE_GLUE_NAME_TYPE_BASE(find_left_bracket,"find-left-bracket", path (*) (path, string, string), path (*) (path, const string&, const string&))
DECLARE_GLUE_NAME_TYPE_BASE(find_right_bracket,"find-right-bracket", path (*) (path, string, string), path (*) (path, const string&, const string&))
