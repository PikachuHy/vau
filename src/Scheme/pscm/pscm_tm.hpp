...
inline bool tmscm_is_int (tmscm obj) { return obj.is_num() && obj.to_number()->is_int(); }
inline bool tmscm_is_double (tmscm obj) { return obj.is_num() && obj.to_number()->is_float(); }
...
void scm_new_procedure(const char* name, auto f, int args, int p0, int p1) {
