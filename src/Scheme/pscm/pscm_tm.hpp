...
inline bool tmscm_is_equal (tmscm o1, tmscm o2) { return pscm::Cell::is_equal(o1, o2); }



inline bool tmscm_is_null (tmscm obj) { return obj.is_nil(); }
inline bool tmscm_is_pair (tmscm obj) { return obj.is_pair(); }
inline bool tmscm_is_list (tmscm obj) { return obj.is_pair() || obj.is_nil(); }
inline bool tmscm_is_bool (tmscm obj) { return obj.is_bool(); }
inline bool tmscm_is_int (tmscm obj) { return obj.is_num() && obj.to_num()->is_int(); }
inline bool tmscm_is_double (tmscm obj) { return obj.is_num() && obj.to_num()->is_float(); }
inline bool tmscm_is_string (tmscm obj) { return obj.is_str(); }
inline bool tmscm_is_symbol (tmscm obj) { return obj.is_sym(); }

inline tmscm tmscm_cons (tmscm obj1, tmscm obj2) { return pscm::cons (obj1, obj2); }
inline tmscm tmscm_car (tmscm obj) { return pscm::car (obj); }
inline tmscm tmscm_cdr (tmscm obj) { return pscm::cdr (obj); }
inline tmscm tmscm_caar (tmscm obj) { return pscm::caar (obj); }
inline tmscm tmscm_cadr (tmscm obj) { return pscm::cadr (obj); }
inline tmscm tmscm_cdar (tmscm obj) { return pscm::cdar (obj); }
inline tmscm tmscm_cddr (tmscm obj) { return pscm::cddr (obj); }
inline tmscm tmscm_caddr (tmscm obj) { return pscm::caddr (obj); }
inline tmscm tmscm_cadddr (tmscm obj) { return pscm::cadddr (obj); }
...
#define TMSCM_UNSPECIFIED pscm::Cell::none()

void scm_new_procedure(const char* name, FN f, int args, int p0, int p1);
